    ...
    divison(vector<string> v)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            do
            {
                ...
                {
                case 0:
                    this->teamNames.push_back(word);
                    break;
                case 1:
                    this->wins.push_back(stringToNumber(word));
                    break;
                case 2:
                    this->loss.push_back(stringToNumber(word));
                    break;
                case 3:
                    this->left.push_back(stringToNumber(word));
                    break;
                default:
                    this->games[i].push_back(stringToNumber(word));
                    break;
                }
                j++;
            } while (s);
